                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          value: _selectedBank,
                          isExpanded: true,
                          hint: const Text("Bank tujuan", style: TextStyle(fontSize: 14, color: Colors.black87)),
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_selectedBank != null && _rekController.text.isNotEmpty) {
                      
                      // MOCKING DATA
                      String namaDariBackendMock = "Farrel Rizqi Muhammad"; 
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => TransferRiwayatScreen(
                            namaPenerima: namaDariBackendMock,   
