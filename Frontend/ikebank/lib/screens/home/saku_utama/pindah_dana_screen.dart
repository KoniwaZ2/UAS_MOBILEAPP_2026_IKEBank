...
class _PindahDanaScreenState extends State<PindahDanaScreen> {
  ...
  String _selectedTujuan = "Uang Belanja";
  String _selectedTujuanSaldo = "Rp 5.000.000";
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Dari", style: TextStyle(fontSize: 12, color: Colors.black)),
                          SizedBox(height: 4),
                          Text("Saku Utama", style: TextStyle(fontSize: 16, color: Colors.black)),
                          SizedBox(height: 2),
                          Text("Rp 3.000.000", style: TextStyle(fontSize: 14, color: Colors.black)),
                        ],
                      ),
                    ),
                  ],
