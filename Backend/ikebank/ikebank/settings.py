"""
Django settings for ikebank project.
...
SECRET_KEY = 'django-insecure-88wnfzg)1^8u4d_pabb8ud^vw#&=-xsg%2)kjylvpia-xs=9-i'
...
WSGI_APPLICATION = 'ikebank.wsgi.application'
